                ...
                <div className="row align-items-center justify-content-center">
                    ...
                    <div className="col-lg-8 col-md-8">
                        <ul className="topbar-action-list">
                            <li><i className='bx bxs-map'></i> 2750 Quadra Street Victoria Road, New York, Canada</li>
                            <li>
                                <i className='bx bxs-phone'></i> <span>Call</span> <a href="tel:1234567890">+123 456 7890</a>
                            </li>
                        </ul>
                    </div>
                </div>
