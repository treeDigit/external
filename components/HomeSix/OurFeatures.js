...
class OurFeatures extends Component {
    ...
    render() {
        return (
            <>
                <section className="features-area ptb-100 gray-bg">
                    <div className="container">
                        ...
                        <div className="tab features-list-tab">
                            ...
                            <ul className="tabs">
                                ...
                                >
                                    <div className="bg-fa7070" onClick={(e) => e.preventDefault()}>
                                        <i className="flaticon-achievement"></i>
                                        <span>User Experience</span>
                                    </div>
                                </li>
                                <li onClick={(e) => this.openTabSection(e, 'tab2')}>
                                    <div className="bg-00aeff" onClick={(e) => e.preventDefault()}>
                                        <i className="flaticon-architecture"></i>
                                        <span>Product Design</span>
                                    </div>
                                </li>
                                <li onClick={(e) => this.openTabSection(e, 'tab3')}>
                                    <div className="bg-c679e3" onClick={(e) => e.preventDefault()}>
                                        <i className="flaticon-digital-marketing"></i>
                                        <span>Digital Marketing</span>
                                    </div>
                                </li>
                                <li onClick={(e) => this.openTabSection(e, 'tab4')}>
                                    <div className="bg-eb6b3d" onClick={(e) => e.preventDefault()}>
                                ...
                                <li onClick={(e) => this.openTabSection(e, 'tab6')}>
                                    <div className="bg-f78acb" onClick={(e) => e.preventDefault()}>
                            ...
                            <div className="tab_content">
                                {/* Tabs Item 01 */}
                                <div id="tab1" className="tabs_item bg-white">
                                ...
                                {/* Tabs Item 02 */}
                                <div id="tab2" className="tabs_item bg-white">
                                    <div className="features-overview">
                                        <div className="overview-image">
                                            <div className="image">
                                ...
                                {/* Tabs Item 03 */}
                                <div id="tab3" className="tabs_item bg-white">
                                    <div className="features-overview">
                                        <div className="overview-content">
                                            <div className="content">
                                                <span className="sub-title">Define Your Choices</span>
                                ...
                                {/* Tabs Item 04 */}
                                <div id="tab4" className="tabs_item bg-white">
                                    <div className="features-overview">
                                        <div className="overview-image">
                                            <div className="image">
                                ...
                                {/* Tabs Item 05 */}
                                <div id="tab5" className="tabs_item bg-white">
                                    <div className="features-overview">
                                        <div className="overview-content">
                                            <div className="content">
                                                <span className="sub-title">Define Your Choices</span>
                                ...
                                {/* Tabs Item 06*/}
                                <div id="tab6" className="tabs_item bg-white">
                                    <div className="features-overview">
                                        <div className="overview-image">
                                            <div className="image">
