                            ...
                            <div className="single-product-box">
                                <div className="product-image">
                                    <Link href="/single-product">
                                        <a>
                                            <img src="/images/shop/item1.jpg" alt="image" />
                                            <img src="/images/shop/item1-hover.jpg" alt="image" />
                                        </a>
                                    </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-product-box">
                                <div className="product-image">
                                    <Link href="/single-product">
                                        <a>
                                            <img src="/images/shop/item2.jpg" alt="image" />
                                            <img src="/images/shop/item2-hover.jpg" alt="image" />
                                        </a>
                                    </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-product-box">
                                <div className="product-image">
                                    <Link href="/single-product">
                                        <a>
                                            <img src="/images/shop/item3.jpg" alt="image" />
                                            <img src="/images/shop/item3-hover.jpg" alt="image" />
                                        </a>
                                    </Link>
